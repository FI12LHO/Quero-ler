...
export default function BookDetail({data, hidden, onHandleclose}:Prop) {
    let yearPublishing = data.publishedDate.split('-')[0];
    let popupStyle = 'fixed z-10 bg-[#00000060] w-screen h-screen flex items-center justify-center';
    ...
    return(
        <div className={hidden ? `${popupStyle} hidden` : popupStyle }>
            <span className="w-screen h-screen" onClick={handleClose}></span>
            <div className='
